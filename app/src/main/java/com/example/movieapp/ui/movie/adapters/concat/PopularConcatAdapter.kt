...
import com.example.movieapp.databinding.PopularMoviewRowBinding
...
class PopularConcatAdapter(private val moviesAdapter: MovieAdapter) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding =
            PopularMoviewRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ConcatViewHolder(val binding: PopularMoviewRowBinding) :
